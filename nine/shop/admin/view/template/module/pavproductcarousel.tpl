...
function addModule() {	
	...
	html += '    <td class="left"><input type="text" name="pavproductcarousel_module[' + module_row + '][width]" value="" size="3" /> <input type="text" name="pavproductcarousel_module[' + module_row + '][height]" value="" size="3" /></td>';
	html += '    <tr>';
	html += '    </tr>';
